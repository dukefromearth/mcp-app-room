...
import { appendRoomEvidence, buildRoomAssurance } from "./store/evidence";
...
export class RoomStore {
  ...
  private appendEvidence(
    ...
    room.evidenceCounter = appendRoomEvidence({
      evidence: room.evidence,
      evidenceCounter: room.evidenceCounter,
      evidenceHistoryLimit: this.evidenceHistoryLimit,
      revision,
      payload,
    });
  }
  ...
  private buildState(room: RoomRuntime): RoomState {
    ...
    return {
      ...
      invocations,
      evidence,
      assurance: buildRoomAssurance(mounts, evidence),
    };
  }
